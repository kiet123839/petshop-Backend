...
public class ProductService {
    ...
    // Lấy sản phẩm đang hoạt động (isActive = true)
    ...
    public ProductResponse createProduct(ProductRequest request) {
        ...
        p.setUnit(request.getUnit() != null ? request.getUnit() : "cái");
    ...
    public ProductResponse updateProduct(Long id, ProductRequest request) {
        ...
        if (request.getProductName()   != null) p.setProductName(request.getProductName());
        ...
        if (request.getStockQuantity() != null) p.setStockQuantity(request.getStockQuantity());
        if (request.getUnit()          != null) p.setUnit(request.getUnit());
    ...
    private ProductResponse toResponse(Product p) {
        ...
        res.setIsActive(p.getIsActive());   // Lombok @Getter trả đúng isActive từ DB
